...
import { runDailyAutonomousJob, runSmartAutonomousJob, runTopCharactersAutonomousJob } from "@/lib/services/orchestratorService";
...
export async function POST(request: NextRequest) {
  ...
  const { jobId='', topTen=false } = await request.json();
  ...
  runTopCharactersAutonomousJob(id, false, topTen); 
