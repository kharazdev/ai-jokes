...
import { runDailyAutonomousJob, runHighVolumeCharacterJob, runSmartAutonomousJob, runTopCharactersAutonomousJob } from "@/lib/services/orchestratorService";
...
export async function POST(request: NextRequest) {
    ...
    const { jobId = '', topTen = false, characterId } = await request.json();
    ...
    runHighVolumeCharacterJob({ jobId: id, characterId });
